...
class Config:
    def __init__(self): #调用此类是初始化运行函数或方法s
        ...
        self.Dis_mean = 30  # -np.log(gta_real[bbox_num, 4]/C.Dis_mean)近红外距离归一化标准距离distance_ped_mean=33.97178154169947
        self.Dis_max = 80  # -np.log(gta_real[bbox_num, 4]/C.Dis_mean)近红外距离归一化标准距离distance_ped_mean=33.97178154169947
        ...
        self.num_rois = 32 # number of ROIs at once.  classifier net 每批次检测RoI数量为32个
        ...
        self.classifier_min_overlap = 0.45 #分类时最小交并比阈值self.classifier_min_overlap = 0.50
        self.classifier_max_overlap = 0.50 #分类时最大交并比阈值self.classifier_max_overlap = 0.50
